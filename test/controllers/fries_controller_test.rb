...
class FriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fry" do
    assert_difference("Fry.count") do
      post fries_url, params: { fry: { description: @fry.description, image: @fry.image, name: @fry.name, price: @fry.price } }
    end
  ...
  test "should update fry" do
    patch fry_url(@fry), params: { fry: { description: @fry.description, image: @fry.image, name: @fry.name, price: @fry.price } }
